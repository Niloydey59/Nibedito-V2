...
export default function HeroSection({ user }: HeroSectionProps) {
  return (
    <section className="flex items-center justify-between px-[5%] py-16 lg:py-0 bg-gradient-to-br from-white to-gray-50 dark:from-slate-900 dark:to-slate-800 min-h-screen lg:h-[calc(100vh-72px)] relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex-1 max-w-2xl text-center lg:text-left mb-8 lg:mb-0">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            ...
            <span className="text-orange-500 text-5xl md:text-6xl lg:text-7xl">
              Occasion
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            <Link
              href="/products"
              className="group relative inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-red-600 to-orange-500 text-white font-medium rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-105"
            >
            ...
            <Link
              href="/categories"
              className="relative inline-flex items-center justify-center px-8 py-3 border-2 border-orange-500 text-orange-500 dark:text-orange-400 font-medium rounded-lg overflow-hidden z-10 transition-all duration-300 hover:text-white dark:hover:text-white group"
            >
              <span className="absolute inset-0 bg-orange-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left z-[-1]"></span>
