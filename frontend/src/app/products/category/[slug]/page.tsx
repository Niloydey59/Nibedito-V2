    ...
    useEffect(() => {
        const fetchCategoryData = async () => {
            try {
                ...
                const subcategoriesData = await subcategoryService.getSubcategoriesByCategory(categoryData._id);
                ...
                if (selectedSubcategory) {
                    ...
                    const productsData = await productService.getProductsBySubcategory(selectedSubcategory, params);
                    ...
                    const productsData = await productService.getProductsByCategory(slug, params);
        ...
        fetchCategoryData();
    }, [slug, selectedSubcategory, page, limit, sortBy, minPrice, maxPrice, search, searchParams]);
    ...
    return (
        <main className="category-subcategory-page products-page">
            <div className="products-container">
                ...
                {showMobileOverlay && (
                    <div className="mobile-filter-overlay visible" onClick={hideFilters}></div>
                )}
